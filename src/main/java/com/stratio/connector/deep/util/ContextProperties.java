...
public class ContextProperties {
    ...
    public ContextProperties() {
        ...
        try {
            ...
            port = ! prop.get("port").equals("") ? Integer.valueOf((String)prop.get("port")): Constants.DEFAULT_CASSANDRA_CQL_PORT;
            thriftPort = ! prop.get("thriftPort").equals("") ? Integer.valueOf((String)prop.get("thriftPort")): Constants.DEFAULT_CASSANDRA_RPC_PORT;
